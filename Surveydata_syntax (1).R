#$Rev: 9205 $ .
dfeng <- read.table("survey_28396_data_file (2).csv", sep=",", quote = "'", na.strings=c("","\"\""), stringsAsFactors=FALSE)

dfger <- read.table("survey_49122_data_file (2).csv", sep=",", quote = "'", na.strings=c("","\"\""), stringsAsFactors=FALSE)

dfesp <- read.table("survey_65596_data_file (2).csv", sep=",", quote = "'", na.strings=c("","\"\""), stringsAsFactors=FALSE)
